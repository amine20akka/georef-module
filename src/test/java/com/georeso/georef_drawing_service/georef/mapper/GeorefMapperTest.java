...
import com.georeso.georef_drawing_service.georef.dto.GcpDto;
import com.georeso.georef_drawing_service.georef.dto.GeorefImageDto;
import com.georeso.georef_drawing_service.georef.dto.GeorefLayerDto;
...
public class GeorefMapperTest {
    ...
    void shouldMapGeorefImageToDtoCorrectly() {
        ...
        // WHEN
        GeorefImageDto dto = GeorefMapper.toDto(image, gcpDtos, layerDto);
    ...
    void shouldMapDtoToGeorefImageCorrectly() {
        ...
        // WHEN
        GeorefImage entity = GeorefMapper.toEntity(dto);
